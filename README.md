# CHATCHW Knowledge Management Repository

## Overview
This repository contains the centralized documentation, references, planning materials, and knowledge-management assets for the **CHATCHW Research Team**, led by Professor Levine. Its purpose is to maintain an organized, accessible, and version-controlled hub for all project-related materials, including PDFs, Google Docs exports, spreadsheets, agendas, procedures, and reference documents.
...
1. Download and work locally in your own branch.
2. Add or update documents within the appropriate folder.
3. Commit with a clear message describing what was added or modified.
4. Push changes to GitHub and open a pull request for review.
